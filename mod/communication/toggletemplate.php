...
/**
 * Toggle visibility of a communication template
 *
...
if (confirm_sesskey()) {
    ...
    $DB->set_field('communication_templates', 'disabled', $template->disabled ? 0 : 1, array('id' => $templateid));

    $message = get_string($template->disabled ? 'templateenabled' : 'templatedisabled', 'communication', $template->name);
