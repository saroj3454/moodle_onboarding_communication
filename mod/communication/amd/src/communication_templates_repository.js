...
/**
 * A javascript module to retrieve communication templates from the server.
 *
 * @module     mod_communication/communication_templates_repository
 * @class      repository
...
define(['jquery', 'core/ajax', 'core/notification'], function($, Ajax, Notification) {
     ...
     *
     * Valid args are:
     * int from  Only get templates after this number
    ...
    var query = function(args) {
        ...
        var request = {
            methodname: 'mod_communication_get_templates',
            args: args
        };
