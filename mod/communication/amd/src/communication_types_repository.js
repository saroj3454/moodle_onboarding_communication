...
/**
 * A javascript module to retrieve communication types from the server.
 *
 * @module     mod_communication/communication_types_repository
 * @class      repository
...
define(['jquery', 'core/ajax', 'core/notification'], function($, Ajax, Notification) {
     ...
     *
     * Valid args are:
     * int from  Only get types after this number
    ...
    var query = function(args) {
        ...
        var request = {
            methodname: 'mod_communication_get_messagetypes',
            args: args
        };
